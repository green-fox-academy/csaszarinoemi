...
window.onload = function () {
  ...
  //upload the first picture as main and add description to it
  ...
  // add picture as main to the middle

  let imgCounter = 0;
  
  function setPictureWithDescription() {
  ...
  function addBorder() {
    footer.forEach(e => {
      e.classList.remove('footerBorder');
    })
    footer[imgCounter].classList.add('footerBorder');
  }
